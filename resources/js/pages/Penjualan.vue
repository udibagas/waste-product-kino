<template>
    <el-card>
        ...
        <el-form :inline="true" class="form-right">
            <el-form-item>
                <el-button @click="addData" type="primary"><i class="el-icon-plus"></i> INPUT PENJUALAN</el-button>
            </el-form-item>
            <el-form-item>
                ...
                <el-row :gutter="15">
                    ...
                    <el-col :span="12">
                        ...
                        <el-form-item label="Kontak Pembeli">
                            <el-input placeholder="Kontak Pembeli" v-model="formModel.kontak_pembeli"></el-input>
