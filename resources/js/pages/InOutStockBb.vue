<template>
  <div>
    ...
    >
      ...
      >
        <template slot-scope="scope">{{ scope.row.barang.kode }} - {{ scope.row.barang.nama }}</template>
      </el-table-column>
      ...
      <el-table-column
        ...
        header-align="right"
      >
        <template slot-scope="scope">{{ scope.row.stock_in | formatNumber }}</template>
      </el-table-column>
      <el-table-column
        prop="stock_out"
        min-width="110"
        ...
        header-align="right"
      >
        <template slot-scope="scope">{{ scope.row.stock_out | formatNumber }}</template>
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    requestData: function() {
      ...
      this.loading = true;
      axios
        .get("/inOutStockBb", { params: Object.assign(params, this.filters) })
        .then(r => {
